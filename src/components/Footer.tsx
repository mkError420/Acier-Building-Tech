      ...
      <div className="container mx-auto px-6">
            ...
            <div className="flex gap-4">
              {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 border border-white/10 flex items-center justify-center rounded-sm text-white/40 hover:text-brand-orange hover:border-brand-orange transition-all duration-300"
                >
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={link.name}>
                  <Link to={link.href} className="text-white/40 hover:text-brand-orange transition-colors text-sm font-light uppercase tracking-widest">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["Steel Structures", "Engineering", "Management", "Retrofitting", "Compliance"].map((service) => (
                <li key={service}>
                  <Link to="/services" className="text-white/40 hover:text-brand-orange transition-colors text-sm font-light uppercase tracking-widest">
                    {service}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="bg-white/5 border border-white/10 rounded-none px-4 py-3 text-sm text-white focus:outline-none focus:border-brand-orange w-full"
              />
              <Button className="bg-brand-orange hover:bg-brand-orange/90 text-white rounded-none px-4">
                Join
              </Button>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-12 border-t border-white/5 gap-8">
          ...
          <div className="flex gap-8">
            <a href="#" className="text-white/20 hover:text-white transition-colors text-[10px] uppercase tracking-widest font-bold">Privacy Policy</a>
            <a href="#" className="text-white/20 hover:text-white transition-colors text-[10px] uppercase tracking-widest font-bold">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
